...
class CrudStudent extends React.Component {
    constructor(props){
        super(props);
        this.data = [
            {
        ...
        this.tableColumns = [
            ...
            },
            {
                ...
                accessor:"id",
                Cell: row => (
                   <Link to={'/pestudentcreation/'}> <button style={{display:'block', margin:'auto'}} type="button" className="btn btn-green btn-block">Edit</button></Link>
                )
            },
            {
                Header:"Delete",
