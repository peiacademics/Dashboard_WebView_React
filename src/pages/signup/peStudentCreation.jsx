...
class PeStudentCreation extends React.Component {
    constructor(props){
        super(props);
 ...
 <div className="col-xl-6">
				...
				<Panel>
					...
					<PanelBody>
                        ...
                        <label className="col-md-3 col-form-label">Exam Name</label>
                        <div className="col-md-7"><input type="text" className="form-control" /></div>
                        <label className="col-md-3 col-form-label">Exam Year</label>
                        <div className="col-md-7"><input type="number" className="form-control" /></div>
...
export default PeStudentCreation;